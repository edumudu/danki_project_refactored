...
<section class="box-content b1">
    <h2><i class="fas fa-id-card-alt"></i> Serviços cadastrados</h2>
        ...
        <table>
            ...
            <tbody>
                    ...
                    <?php }} ?>
                        ...
                        <td <?php Site::verificaPermissaoMenu(1); ?>><a class="btn-edit" href="<?php echo INCLUDE_PATH_PANEL.'edit-servico?id='.$value['id']; ?>"><i class="fas fa-edit"></i> Editar</a></td>
